{* Phase 4 specific CSS *}
<link rel="stylesheet" href="plugins/schoolmanager/themes/classic/css/content_importaccounts_phase4.css">
...
<br>
<h3>
    {t 1="4/10"}STEP %1  (LDAP import status): Importing user account objects into LDAP{/t}
</h3>
...
(function() {
    ...
    const monitor = new StatusMonitor({
        ...
        formData: {
            ...
            phaseField: { name: 'phase_04', value: '1' }
        },
        elements: {
            ...
            nextButton: 'input[name="phase_05"]'
        },
        translations: {
