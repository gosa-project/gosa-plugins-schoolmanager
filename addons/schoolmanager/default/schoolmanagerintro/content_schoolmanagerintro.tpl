...
<div class="row">
    <div class="col s12">
        ...
        <div class="section">
            ...
            <div class="row">
                <div class="col s9">
                    <p>{t}Flush all members from course, class, subject and parent groups now? If you click this button, SchoolManager presents to you a list of to be emptied groups and asks for confirmation before actually performing this clean-up task.{/t}</p>
                </div>
                <div class="col s3">
                    <button class="btn-small" name="empty_schoolmgr_groups_now_phase1" type="submit">{t}Empty all SchoolManager groups now!{/t}</button>
                </div>
            </div>
        </div>
